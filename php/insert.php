...
$sql = "INSERT INTO nicolas_cf_llm (prolific_id, cond, id_question, id_pack, question, id_question_ex, id_pack_ex, question_ex, answer, answer_ex prob, initval, rt, time) VALUES ('$prolific_id', '$cond', $id_question, $idpack, '$question', $id_question_ex, $id_pack_ex, '$question_ex','$answer_ex', '$answer', '$prob', '$initval', $rt, NOW())";
